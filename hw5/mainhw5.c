 ...
 * Author: josh
 *
 * Created on April 15, 2015, 1:47 PM
 */
...
int main() {
    ...
    while (1) {
        ...
        // 1) read the accelerometer from all three axes
        ...
        // 2) need to read all 6 bytes in one transaction to get an update
        acc_read_register(OUT_X_L_M, (unsigned char *) mags, 6);

        // 3) read the temperature data. Its a right justified 12 bit two's compliment number
        ...
        while(message[z] && i<64 && j<128) {
            ...
            for (counter1=0; counter1<5; counter1++ ) {
                ...
                for (counter2=0; counter2<8; counter2++ ) {
                    display_pixel_set(i,j,(ASCII[96][k]>>counter2)&1);
                    i++;
                }
                j++;
                k++;
        ...
        // Message to start at row i, column j
        i=32, j=28, k=0, z=0, counter1, counter2;
