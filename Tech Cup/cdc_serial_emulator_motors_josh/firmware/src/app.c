...
//    OC1RS = 0;
    ...
    switch(appData.state)
    {
        ...
        case APP_STATE_CHECK_CDC_READ:
            ...
            /* If a read is complete, then schedule a read, else check if UART has received data */
            ...
            if(appData.isReadComplete == true)
            {
                ...
                if(appData.readBuffer[0]=='\n'||appData.readBuffer[0]=='\r'){
                    ...
                    short COM;
                    COM = (appData.readBuffer[1]<<8) | appData.readBuffer[2];
                    ...
                    else if(COM >= 70 && COM < 140) {
                        LATBbits.LATB7 = 1;
                        OC2RS = 1000;
                        LATBbits.LATB14 = 1;
                        OC1RS = 4000;
                    }
                    else if(COM >= 140 && COM < 210) {
                        LATBbits.LATB7 = 1;
                        OC2RS = 2000;
                        LATBbits.LATB14 = 1;
                        OC1RS = 4000;
                    }
                    else if(COM >= 210 && COM < 280) {
                        LATBbits.LATB7 = 1;
                        OC2RS = 3000;
                        LATBbits.LATB14 = 1;
                        OC1RS = 4000;
                    }
                    else if(COM >= 280 && COM < 360) {
                        LATBbits.LATB7 = 1;
                        OC2RS = 4000;
                        LATBbits.LATB14 = 1;
                        OC1RS = 4000;
                    }
                    else if(COM >= 360 && COM < 430) {
                        LATBbits.LATB7 = 1;
                        OC2RS = 4000;
                        LATBbits.LATB14 = 1;
                        OC1RS = 3000;
                    }
                    else if(COM >= 430 && COM < 500) {
                        LATBbits.LATB7 = 1;
                        OC2RS = 4000;
                        LATBbits.LATB14 = 1;
                        OC1RS = 2000;
                    }
                    else if(COM >= 500 && COM <= 570) {
                        LATBbits.LATB7 = 1;
                        OC2RS = 4000;
                        LATBbits.LATB14 = 1;
                        OC1RS = 1000;
                    }
                    else if(COM >= 570 && COM <= 640) {
                        LATBbits.LATB7 = 1;
                        OC2RS = 4000;
                        LATBbits.LATB14 = 1;
                        OC1RS = 0;
        ...
        case APP_STATE_CHECK_UART_RECEIVE:
            ...
            if(USB_DEVICE_CDC_RESULT_OK != writeRequestResult) {
                // send a number back, incrementing each write
                // invert led at 1 Hz to know something is being sent
                //if (_CP0_GET_COUNT() > 10000000*2) {
                //BSP_LEDToggle( 7 );
                //    _CP0_SET_COUNT(0);
                //}
            }
